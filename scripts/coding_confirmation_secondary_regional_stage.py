...
from scripts import coding_confirmation_secondary_sharded_generate as regional
from gearshift.coding_confirmation_lease import control_root, load_lease, linux_process_identity

SELF = 'scripts/coding_confirmation_secondary_regional_stage.py'
SUPERVISOR = 'scripts/coding_confirmation_secondary_sharded_supervisor.py'
SECONDARY_SOURCE = common.CONFIG + '/secondary_shard_source_manifest.json'
