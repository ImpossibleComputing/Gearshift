...
from scripts import coding_confirmation_secondary_sharded_generate as sharded
...
def run(plan_path, plan_sha256):
    ...
    def start(gpu):
        ...
        command = [str(ROOT / '.pilot-venv/bin/python'), 'scripts/coding_confirmation_secondary_sharded_generate.py',
